...
vim.api.nvim_set_hl(0, "RenderMarkdownH1", { fg = "#f6c983" })
vim.api.nvim_set_hl(0, "RenderMarkdownH2", { fg = "#8aa9f9" })
...
vim.api.nvim_set_hl(0, "@markup.heading.1.markdown", { fg = "#f6c983" })
vim.api.nvim_set_hl(0, "@markup.heading.2.markdown", { fg = "#8aa9f9" })
...
local options = {
  file_types = { "markdown", "copilot-chat", "codecompanion", "quarto" },
  heading = {
    icons = {
      "█ ",
      "██ ",
